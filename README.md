...
**Po volbách** (9.–10. 10.) nedělejte `npm run data:refresh` – `vysledky_celk.xml` by už obsahoval nově zvolené
senátory a obhájci by se přepsali. Uložený snímek v `data-src/incumbents.json` je záměrně zamrzlý.
